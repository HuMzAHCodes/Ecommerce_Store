...
const Shop = () => {
  ...
  const handleAddToCart = (product: Product) => {
    addItem({ id: product.id, name: product.name, price: product.price, salePrice: product.salePrice, image: product.bg, slug: product.slug });
    openDrawer();
    toast.success(`${product.name} added to cart!`);
  };

  const handleWishlist = (product: Product) => {
    toggle({ id: product.id, name: product.name, price: product.price, salePrice: product.salePrice, image: product.bg, slug: product.slug });
